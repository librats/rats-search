...
public:
    ...
    /**
     * @brief Provide access to the running application (for on-demand file fetch).
     */
    ...
    /**
     * @brief Display a torrent's files. Uses the torrent's embedded file list when
     *        present, otherwise fetches it from the repository via the application.
     */
