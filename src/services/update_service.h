...
// relaunching. Ported from the old top-level UpdateManager; behaviour is
// identical, but the batch/shell scripts now live in Qt resources
// (":/update/windows_updater.bat.in", ":/update/unix_updater.sh.in") rather than
// being built inline by string concatenation.
