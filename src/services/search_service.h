...
// repository query, safe-search defaults, torrent-vs-file search) so the API and
// P2P layers share one implementation instead of each building repository
...
public:
    ...
    static bool isInfoHashQuery(const QString& query);
