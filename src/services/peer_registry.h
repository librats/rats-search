...
// The rats-search peer handshake, extracted out of the transport layer. On every
// new connection it exchanges a "client_info" message carrying our index stats,
// and it tracks each peer's advertised stats so the UI/API can show swarm-wide
// totals. This is the application logic that used to be baked into P2PNetwork.
...
public:
    ...
    domain::PeerStats peerStats(const QString& peerId) const;
