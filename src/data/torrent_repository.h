...
// maintained statistics. Replaces the search/CRUD half of the old
// TorrentDatabase god-class; process lifecycle lives in Manticore and raw SQL in
...
public:
    struct SearchQuery {
        ...
        int offset = 0;
        int limit = 10;
        QString sort; // user sort key ("seeders", "size", "added"); mapped to a safe column
