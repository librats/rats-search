...
//
// This is the rats::domain replacement for the old global ContentDetector. The
// detection algorithm is preserved verbatim (weighted-by-size file-type voting,
// plus adult-content word blocking for video/pictures/archive). Only the DATA
// moved: the extension→type table and the bad-word lists are now loaded once
// from the Qt resource bundle (:/content/extensions.json, :/content/badwords.json)
// instead of being compiled into a header.
