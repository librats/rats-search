...
// A BitTorrent v1 info-hash is a 40-character hex SHA-1 digest. This centralises
// the validation that was previously copy-pasted as `hash.length() != 40` in a
// dozen places across the old codebase.
namespace infohash {
